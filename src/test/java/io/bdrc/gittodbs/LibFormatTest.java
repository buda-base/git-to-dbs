...
public class LibFormatTest {
    ...
    public void allTest() throws JsonGenerationException, JsonMappingException, IOException {
        ...
        Map<String, Object> jsonres = LibFormat.modelToJsonObject("P1583", model, DocType.PERSON, personidx, personLabels, personCreations);
        ...
        //om.writerWithDefaultPrettyPrinter().writeValue(System.out, personLabels);
        //om.writerWithDefaultPrettyPrinter().writeValue(System.out, personCreations);
    }
